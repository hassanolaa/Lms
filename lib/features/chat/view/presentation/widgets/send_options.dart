                ...
                Padding(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        ...
                        backgroundColor: backbackground,
                        child: Icon(Icons.camera_alt,
                            size: context.smallfontsize, color: textcolor),
                      ),
                      title: Text('Camera',
                          style: TextStyle(color: textcolor, fontSize: context.smallfontsize)),
                      onTap: () {
                        print('camera');
                        massage_repository.UploadImage_camera(widget.chatid);
                      },
                ...
                Padding(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        radius: 15.r,
                        backgroundColor: backbackground,
                        child: Icon(Icons.photo, size: context.smallfontsize, color: textcolor),
                      ),
                      title: Text('Photo & Video',
                          style: TextStyle(color: textcolor, fontSize: context.smallfontsize)),
                      onTap: () {
